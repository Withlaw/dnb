...
export const useBookService = () => {
	...
	if (!value)
		throw new Error('useBookService need BookServiceProvider.');
...
export const useRentalService = () => {
	...
	if (!value)
		throw new Error('useRentalService need RentalServiceProvider.');
...
export const useAuthService = () => {
	...
	if (!value)
		throw new Error('useAuthService need AuthServicesProvider.');
...
export const useUserService = () => {
	...
	if (!value)
		throw new Error('useUserService need UserServicesProvider.');
