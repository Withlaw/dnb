...
import { disableConfirm, onConfirm } from '@/slices/confirmation.slice.ts';
		...
		<Modal>
			<Modal.Window name="" blured={false}>
				<div className="absolute top-10 flex w-full justify-center">
					<div className=" flex w-72 flex-col items-center justify-center rounded-md border border-stone-300 bg-[#fff] shadow-inner drop-shadow-lg">
						<div className="min-h-20 w-full p-4 text-xs">
							<p>{message}</p>
						</div>
						<div className=" flex w-full justify-center divide-x divide-stone-400 border-t border-stone-300 text-sm">
							<button
